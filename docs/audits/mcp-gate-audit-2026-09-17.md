...
| 4. Copilot CLI / Cursor CLI | same as 2 through `copilot --acp` / `agent acp` (Agent Client Protocol clients answer permission requests programmatically) | full, needs a Copilot license / Cursor login on this machine | not run |
