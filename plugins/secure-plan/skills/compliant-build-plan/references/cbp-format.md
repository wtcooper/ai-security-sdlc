# Compliant Build Plan — format

```markdown
## Compliant Build Plan — <feature>
...
|---|-----------|----------------------------------|-------------|-------------|
| R1 | /api/orders | Parameterize all queries; reject unknown fields with 400 | codeguard-0-input-validation-injection | SAST (llm-code-scan, CodeQL) |
